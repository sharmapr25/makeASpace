const InvalidInstructionError = require('./invalidInstructionError');
...
module.exports = {InvalidTimeInputError, InvalidTimeSlotInputError, MeetingRoomIsAlreadyBookedError, NoMeetingRoomAvailableError, InvalidInstructionError};